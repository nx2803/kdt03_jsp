...
<body
	class="bg-neutral-700 text-white p-8 min-h-screen">
	...
	<h2
		class="text-3xl font-bold mb-8 text-white border-b-2 border-red-700 pb-2">
		목록 보기(List) - 현재 페이지 :
		<%=pageNum%>
		(전체 :
		<%=totalPage%>)
	...
	<form method="get"
		class="mb-8 flex items-center space-x-3 p-4">
	...
	<table class="mx-auto mt-8 mb-8">
		<tr class="text-black">
			<td class="py-2 px-4 text-center"><%=BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, request.getRequestURI())%>
			</td>
		</tr>
	</table>
